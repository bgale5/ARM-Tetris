...
#define GPIOA_RIS 	(*((volatile unsigned long *)0x40004414))
#define GPIOA_IM 	(*((volatile unsigned long *)0x40004410))
#define GPIOA_IS 	(*((volatile unsigned long *)0x40004404))
#define GPIOA_IEV 	(*((volatile unsigned long *)0x4000440C))
#define GPIOA_IBE 	(*((volatile unsigned long *)0x40004408))
...
#define GPIOB_RIS 	(*((volatile unsigned long *)0x40005414))
#define GPIOB_IM 	(*((volatile unsigned long *)0x40005410))
#define GPIOB_IS 	(*((volatile unsigned long *)0x40005404))
#define GPIOB_IEV 	(*((volatile unsigned long *)0x4000540C))
#define GPIOB_IBE 	(*((volatile unsigned long *)0x40005408))
...
#define TIMER0_CTL	 (*((volatile unsigned long *)0x4003200C))
#define TIMER0_CFG	 (*((volatile unsigned long *)0x40032000))
#define TIMER0_TAMR	 (*((volatile unsigned long *)0x40032004))
#define TIMER0_TAPR	 (*((volatile unsigned long *)0x40032038))
#define TIMER0_TAILR	 (*((volatile unsigned long *)0x40032028))
#define TIMER0_TAPMR	 (*((volatile unsigned long *)0x40032040))
#define TIMER0_TAMATCH	 (*((volatile unsigned long *)0x40032030))
